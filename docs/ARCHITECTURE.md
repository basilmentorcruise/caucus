...
- **Claim ledger** — keyed, **first-write-wins**, atomic. The dedup mechanic. A granted claim is also emitted as a `claim`-type message so the hook surfaces it to everyone.
